      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-card/80 backdrop-blur-md border border-border/50 rounded-3xl p-8 shadow-xl">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3 bg-background border border-border rounded-xl hover:bg-accent transition-colors"
          >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3 mt-3 bg-foreground text-background border border-border rounded-xl hover:opacity-90 transition-opacity"
          >
